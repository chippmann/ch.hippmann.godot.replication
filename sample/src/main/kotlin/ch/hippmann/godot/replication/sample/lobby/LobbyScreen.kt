...
class LobbyScreen : Control() {
    ...
    override fun _ready() {
        ...
        column.addThemeConstantOverride("separation".asStringName(), 8)
        column.addChild(Label().apply { text = "Replication sample"; addThemeFontSizeOverride("font_size".asStringName(), 26) })
        ...
        column.addChild(sessions.apply { customMinimumSize = Vector2(0, 64) })
